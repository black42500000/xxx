...
namespace Conquer_Online_Server.Game
{
    ...
    public class SteedRace
    {
        ...
        private void SendInvitations()
        {
            ...
            Kernel.SendWorldMessage(new Network.GamePackets.Message("SteedRace has started You have 1 minute to signup go to TC HorseRaceManager!.", System.Drawing.Color.White, Network.GamePackets.Message.Center), Program.GamePool);
        }
        ...
        {
            Kernel.SendWorldMessage(packet, Program.GamePool, MAPID);
        }
