...
namespace Conquer_Online_Server.Game
{
    public class ClanWar
    {
        ...
        public static void Start()
        {
            ...
            Kernel.SendWorldMessage(new Message("Clan war has began!", System.Drawing.Color.Red, Message.Center), Program.GamePool);
            FirstRound = true;
        ...
        public static void FinishRound()
        {
            ...
            if (PoleKeeper != null)
            {
                ...
                Kernel.SendWorldMessage(new Message("The Clan, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this Clan war round!", System.Drawing.Color.Red, Message.Center), Program.GamePool);
                
                Pole.Name = PoleKeeper.Name;
            }
            Pole.Hitpoints = Pole.MaxHitpoints;
            Kernel.SendWorldMessage(Pole, Program.GamePool, (ushort)1509);
            Reset();
        }
        ...
        public static void End()
        {
            if (PoleKeeper != null)
            {
                Kernel.SendWorldMessage(new Message("The clan, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this Clan war!---Clan war has ended!", System.Drawing.Color.White, Message.Center), Program.GamePool);

                PoleKeeper.PoleKeeper = true;
            }
            else
            {
                Kernel.SendWorldMessage(new Message("Clan war has ended and there was no winner!", System.Drawing.Color.Red, Message.Center), Program.GamePool);
        ...
        public static void SendScores()
        {
            ...
            for (int c = 0; c < scoreMessages.Length; c++)
            {
                ...
                Kernel.SendWorldMessage(msg, Program.GamePool, (ushort)1509);
            }
        }
