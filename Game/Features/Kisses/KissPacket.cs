namespace Conquer_Online_Server.Network.GamePackets
{
    ...
    public class KissPacket : Writer, IPacket
    {
        ...
        public KissPacket(Conquer_Online_Server.Game.Features.Kisses.Kisses ClientKisses, Client.GameClient client)
        {
            ...
            else
            {
                if (ClientKisses != null)
                {
                    ...
                    Writer.WriteUInt32(ClientKisses.Letters, 24, Buffer2);
                    Writer.WriteUInt32(ClientKisses.Letters2day, 28, Buffer2);
