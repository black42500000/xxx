...
namespace Conquer_Online_Server.Game
{
    public class PoleIslanD
    {
        ...
        public static void Start()
        {
            ...
            Kernel.SendWorldMessage(new Message(string.Concat(name), "ALLUSERS", "PoleIslanD", System.Drawing.Color.Red, 2500), Program.GamePool);
            Kernel.SendWorldMessage(new Message("PoleIslanD has began!", System.Drawing.Color.Red, Message.Center), Program.GamePool);
            FirstRound = true;
        ...
        public static void FinishRound()
        {
            ...
            if (PoleKeeper != null)
            {
                ...
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PoleIslanD round!", System.Drawing.Color.Red, Message.Center), Program.GamePool);
        ...
        public static void End()
        {
            if (PoleKeeper != null)
            {
                Kernel.SendWorldMessage(new Message("The guild, " + PoleKeeper.Name + ", owned by " + PoleKeeper.LeaderName + " has won this PoleIslanD!---PoleIslanD has ended!", System.Drawing.Color.White, Message.Center), Program.GamePool);
                //Conquer_Online_Server.Database.EntityTable.Status2(); 
            }
            else
            {
                Kernel.SendWorldMessage(new Message("PoleIslanD has ended and there was no winner!", System.Drawing.Color.Red, Message.Center), Program.GamePool);
                //Conquer_Online_Server.Database.EntityTable.Status2(); 
            }
            IsWar = false;
            Claim = true;
