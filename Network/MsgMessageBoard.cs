...
namespace COServer.Network
{
    public unsafe class MsgMessageBoard
    {
        ...
        public static void Create(Conquer_Online_Server.Client.GameClient client, UInt16 Index, ushort Channel, String[] Params, Action Action)
        {
            try
            {
                int StrLength = 0;
            ...
            catch (Exception Exc) { Conquer_Online_Server.Program.WriteLine(Exc); return; }
        }
        public static Encoding Encoding = Encoding.GetEncoding("iso-8859-1");
        public static void Process(Conquer_Online_Server.Client.GameClient Client, Byte[] Buffer)
        {
            try
            {
                ushort MsgLength = Conquer_Online_Server.BitConverter.ToUInt16(Buffer, 0);
                ushort MsgId = Conquer_Online_Server.BitConverter.ToUInt16(Buffer, 2);
                ushort Index = Conquer_Online_Server.BitConverter.ToUInt16(Buffer, 8);
                ushort Channel = Conquer_Online_Server.BitConverter.ToUInt16(Buffer, 10);
                ...
                //  Conquer_Online_Server.Game.Entity Player = Client.User;
                    ...
                    case Action.GetWords:
                        {
                            ...
                            Client.Send(new Conquer_Online_Server.Network.GamePackets.Message(Param, Client.Entity.Name, Words, (ushort)Channel, System.Drawing.Color.White));
                            return;
                        }
                    default:
                        {
            ...
            catch (Exception Exc) { Conquer_Online_Server.Program.WriteLine(Exc); }
        }
    }
}
