...
namespace Conquer_Online_Server.Network.GamePackets
{
    public static class MovementHandler
    {
        /*public static class MovementHandler
        {
            ...
            public static void Walk(Movement movement, Client.GameClient client)
            {
                ...
                foreach (Client.GameClient other in client.Map.Entities.Values)
            ...
            public static void Ride(Packets.Movement movement, Client.GameClient client)
            {
                client.Entity.Direction = (byte)(movement.Direction % 8);
                client.Entity.Action = 0;
                ...
                #region Screen Checks
                foreach (Client.GameClient other in client.Map.Players.Values)
                    if (client.Identity != other.Identity)
                        if (Kernel.InScreen(_x, _y, other.Character.X, other.Character.Y))
                        {
                            if (!other.Screen.InScreen.ContainsKey(client.Identity))
            ...
            public static void Jump(Packets.GeneralAction action, Client.GameClient client)
            {
                try
                {
