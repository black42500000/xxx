...
namespace Conquer_Online_Server.Database
{
    ...
    public class KissesystemTable
    {
        ...
        public static void Kisses(Client.GameClient Client)
        {
                ...
                if (reader.Read())
                {
                    ...
                    if ((Client.Entity.Body == 1003) || (Client.Entity.Body == 1004 || Client.Entity.Body == 2003) || (Client.Entity.Body == 2004))
                    {
                        if (Client.Entity.Kisses.LastKissesSent.AddDays(1) <= DateTime.Now)
                        {
                            ...
                            Client.Entity.Kisses.Letters2day = 0;
                        ...
                        else
                        {
                            ...
                            Client.Entity.Kisses.Letters2day = reader.ReadUInt32("letterstoday");
        ...
        public static void Insert(Client.GameClient client)
        {
            using (var cmd = new MySqlCommand(MySqlCommandType.INSERT).Insert("kisses"))
             ...
             .Insert("letters", client.Entity.Kisses.Letters)
             .Insert("letterstoday", client.Entity.Kisses.Letters2day)
        ...
        public static void SaveKissTable(Client.GameClient client)
        {
            using (var cmd = new MySqlCommand(MySqlCommandType.UPDATE))
                cmd.Update("kisses")
               .Set("letters", client.Entity.Kisses.Letters)
               .Set("kisses", client.Entity.Kisses.Kisses2)
               .Set("Jades", client.Entity.Kisses.Jades)
               .Set("wine", client.Entity.Kisses.Wine)
               .Set("letterstoday", client.Entity.Kisses.Letters2day)
