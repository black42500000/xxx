...
namespace Conquer_Online_Server.Database
{
    public class KnownPersons
    {
        ...
        public static void LoadMentor(Client.GameClient client)
        {
            ...
            using (var reader = cmd.CreateReader())
            {
                if (reader.Read())
                {
                    ...
                    client.AsApprentice = new Conquer_Online_Server.Game.ConquerStructures.Society.Apprentice();
        ...
        public static void SaveApprenticeInfo(Conquer_Online_Server.Game.ConquerStructures.Society.Apprentice app)
        {
            if (app != null)
            {
        ...
        public static void AddMentor(Mentor mentor, Conquer_Online_Server.Game.ConquerStructures.Society.Apprentice appr)
        {
